    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      <TabsContent value="overview" className="space-y-5 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-3">
          ...
          <Card className="p-4 sm:p-6">
            <div className="mb-6">
              <h3 className="mb-1 text-foreground">Insights Clave</h3>
              <p className="text-sm text-muted-foreground">Hallazgos destacados</p>
            </div>
            <div className="space-y-3 sm:space-y-4">
              <div className="p-4 bg-blue-50 rounded-xl border border-blue-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="mb-1 text-sm font-semibold text-foreground">Crecimiento sostenido</p>
                    <p className="text-xs text-muted-foreground">La tasa de nuevos registros se mantiene estable con tendencia positiva</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-xl border border-green-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="mb-1 text-sm font-semibold text-foreground">Meta alcanzada</p>
                    <p className="text-xs text-muted-foreground">Superado el objetivo trimestral de cobertura en un 15%</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-orange-50 rounded-xl border border-orange-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="mb-1 text-sm font-semibold text-foreground">Área de mejora</p>
                    <p className="text-xs text-muted-foreground">El empleo requiere mayor atención y programas específicos</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="mb-1 text-sm font-semibold text-foreground">Eficiencia óptima</p>
                    <p className="text-xs text-muted-foreground">El tiempo de respuesta ha mejorado 23% este mes</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="p-4 sm:p-6">
        <div className="mb-6">
          <h3 className="mb-1 text-foreground">Análisis Demográfico por Edad</h3>
          <p className="text-sm text-muted-foreground">Distribución etaria de los miembros del hogar</p>
          </div>
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={demographicData}>
              <CartesianGrid strokeDasharray="3 3" stroke="#E5E7EB" />
              <XAxis dataKey="edad" stroke="#6B7280" />
              <YAxis stroke="#6B7280" />
              <Tooltip
                contentStyle={{ backgroundColor: 'white', border: '1px solid #E5E7EB', borderRadius: '8px' }}
              />
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-3">
          <Card className="p-4 sm:p-6 lg:col-span-2">
          <div className="mb-6">
            <h3 className="mb-1 text-foreground">Distribución Territorial</h3>
            <p className="text-sm text-muted-foreground">Concentración por zonas geográficas</p>
            </div>
            <div className="space-y-4">
              {(() => {
                // DATOS REALES - Distribución por barrios
                ...
                return topAreas.map((zona, idx) => (
                  <div key={idx} className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <MapPin className={`size-5 text-${["blue", "green", "purple", "orange", "pink", "cyan"][idx]}-600`} />
                        <span className="text-sm font-medium text-foreground">{zona.zona}</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className="text-sm text-muted-foreground">{zona.familias} familias</span>
                        <Badge variant="secondary" className="bg-muted text-muted-foreground">{zona.porcentaje}%</Badge>
                      </div>
                    </div>
                    <div className="h-2 w-full overflow-hidden rounded-full bg-border">
                      <div
                        className={`h-full bg-gradient-to-r from-${["blue", "green", "purple", "orange", "pink", "cyan"][idx]}-500 to-${["blue", "green", "purple", "orange", "pink", "cyan"][idx]}-600`}
